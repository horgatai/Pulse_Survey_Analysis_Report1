...
**[→ View Live Report]([[https://[your-username].github.io/[your-repo-name]/](https://horgatai.github.io/Pulse_Survey_Analysis_Report1/)](https://horgatai.github.io/Pulse_Survey_Analysis_Report1/
))**
...
The survey covered 10 questions across five key areas:

| Area | Questions |
|---|---|
| Overall HR Experience | Q1 |
| Onboarding Support | Q2, Q3 |
| Learning & Development | Q4, Q5 |
| Wellbeing & Psychological Safety | Q6, Q7 |
| Future Readiness & HR Vision | Q8, Q9, Q10 (NPS) |
...
```
📁 /
├── index.html        # Full interactive report (charts, qualitative analysis, recommendations)
└── README.md         # This file
```
